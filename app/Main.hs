...
main = do
  ...
  runBeamSqlite conn $ do
    ...
    insertUser "user1"
    insertUser "user2"
    group1 <- insertGroup "group1" "This is group 1"
    group2 <- insertGroup "group2" "This is group 2"
...
createTables = do
  ...
  execute_ conn "CREATE TABLE IF NOT EXISTS groups (id TEXT PRIMARY KEY, name TEXT NOT NULL, description TEXT NOT NULL);"
